...
class ActivityLogBlock(QFrame, Block):
    """Side panel listing activity logs and the log file summary."""

    @dataclass(frozen=True)
    class Text:
        """Placeholders and helper copy for the activity log block."""
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(logs_group_box, 1)

        self.ui: ActivityLogBlock.UI = ActivityLogBlock.UI(
    ...
    def _set_size_policy(self) -> None:
        """Centralize size policies for the activity log block."""
