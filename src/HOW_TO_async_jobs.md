...
Wireless device authentication enables the network and mDNS checks. Startup,
device refresh, and close do not require host networking because they must remain
usable with USB-connected devices.
