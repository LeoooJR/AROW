...
def test_on_activity_log_file_update_requested_delegates_to_model_entrypoint() -> None:
...
def test_on_activity_log_file_updated_forwards_path_to_view() -> None:
    probe = _AppControllerActivityLogProbe()
...
def test_sync_activity_log_file_to_view_forwards_current_model_path() -> None:
    probe = _AppControllerActivityLogProbe()
    custom_path = Path("/tmp/custom/activity_20260531.log")
